...
export function PageNumber({ current, total }: SlideProps) {
  return (
...
export function ContentSlide(props: SlideProps) {
  return (
...
export function CodeSlide(props: SlideProps) {
  return (
    <div className="relative h-full w-full p-16">
...
export function TwoColumnSlide(props: SlideProps) {
  return (
